...
export default function InquirySection() {
  ...
  return (
    <section id="inquiry" className="py-16 sm:py-24 bg-white dark:bg-slate-950 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-sky-100 dark:bg-sky-950/70 text-sky-700 dark:text-sky-300 text-xs font-bold uppercase tracking-wider">
              <MessageSquare className="w-3.5 h-3.5 text-sky-600 dark:text-sky-400" />
              <span>Admissions & Counseling Desk</span>
            </div>

            <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">
              Start Your Journey With <span className="text-sky-600 dark:text-sky-400">DSC Bhopal</span>
            </h2>
            ...
            <div className="space-y-4 pt-2">
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Headquarters Campus</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">{instituteData.primaryCenter.address}</p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Direct Counseling Helplines</h4>
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Counseling Hours</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">Monday to Sunday: 8:00 AM – 8:30 PM (All 7 Days Open)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-slate-50 dark:bg-slate-900 p-6 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
            ...
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 text-xs focus:outline-none focus:border-sky-500 text-slate-900 dark:text-white"
                    />
                  </div>

                  <div>
                    <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Parent / Student Phone *</label>
                    <input
                      type="tel"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Target Stream *</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Current Class *</label>
                    <select
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Preferred Bhopal Center</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Questions / Specific Academic Needs (Optional)</label>
                  <textarea
                    rows={3}
              ...
              <div className="py-8 text-center space-y-4">
                ...
                <h3 className="text-xl font-black text-slate-900 dark:text-white">Inquiry Received Successfully!</h3>
                <p className="text-xs text-slate-600 dark:text-slate-400 max-w-md mx-auto">
                  Thank you, <strong>{formData.name}</strong>. Our senior academic counselor from Kasturba Nagar Center will call you on <strong>{formData.phone}</strong> with batch timings, fee structures, and DSSET scholarship options.
                </p>
                <div className="pt-2">
                  <a
