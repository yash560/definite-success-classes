        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12" data-aos="fade-up">
          <div>
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight">
              Rated <span className="text-amber-600">{instituteData.rating} / 5.0</span> Across Bhopal
            </h2>
          ...
          <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm flex items-center gap-4 self-start md:self-auto">
            ...
            <div className="text-xs">
              ...
              <p className="text-slate-600 font-bold mt-0.5">Based on 1,200+ Reviews</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reviewsData.map((review, idx) => (
            <div
              ...
              className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col justify-between"
            >
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 font-medium">{review.course}</p>
                  </div>
                </div>
